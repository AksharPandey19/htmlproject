(function() {
    ...
    function jb() {
        ...
        ra = {
            ...
            319E3: [0, 6, 14, 10],
            32E4: [0, 6, 6, 10],
            335E3: [0, 11, 11, 12, "OK STOP IT"],
            336E3: [0, 9, 11, 12],
            337E3: [0, 11, 9, 12],
            338E3: [0, 9, 9, 12],
            35E4: [0, 19, 19, 11, "STTTTTTTOP IT"],
            352E3: [0, 1, 19, 11],
            354E3: [0, 1, 1, 11],
            355E3: [0, 19, 1, 11],
            365E3: [0, 10, 8, 10],
            366E3: [0, 11, 9, 10,"Nah STOP IT"],
            367E3: [0, 12, 10, 10],
            368E3: [0, 11, 11, 10],
            369E3: [0, 10, 12, 10],
            37E4: [0, 9, 11, 10],
            371E3: [0, 8, 10, 10, "JUST STOP IT"],
            372E3: [0, 9, 9, 10],
            395E3: [0, 1, 1, 12],
            395001: [0, 1, 19, 12],
            395002: [0, 19, 19, 12],
            395003: [0, 20, 1, 12, "OK STOP IT NOW"],
            395004: [0, 10, 10, 12],
            425E3: [0, 0, 10, 13],
            425001: [0, 20, 10, 13],
            570001: [0, 10, 10, 13, "I Quit MAYBE NOT"],
        };
        Wa = void 0;
        for (var a = 0; a < Z; a++) {
            T.push([]);
        ...
        z.stop();
        K.stop();
        record = parseFloat(Ja.getItem("high-record") || 0);
    ...
    function pb() {
        return "I reached " + J.toFixed() + " " + (za ? "#evilMode " : "") + "points in #evilGlitch #Games #BestGames By Akshar "
    }
    ...
    function rb(a) {
        ...
        if (Ca) Da++, 30 < Da && (Da = 0);
            ...
            1694 < ka && (Ea = !1, J = 3E5, wave = 7, F = [], U = [], za = !0, Ja.setItem("cool-gm", "qyui"), mb());
            ka++
        } else if (0 > E[6]) {
            a = dt;
            if (!ea) {
                ...
                if (Ta(f)) {
                    ...
                    W[0][3] = !0;
                    t = 30 * dt;
                    if (Ka = J > record) record = J, Ja.setItem("high-record",
                        J), W[1][3] = !0, W[2][3] = !0;
                    ja = 0
                }
        ...
        if (Ca) {
            ...
            C("made by akshar", 401, 520, 9, [0, 10]);
            e.closePath();
            e.fill();
            e.stroke();
            e.restore()
    ...
    for (var W = [
            ...
            [120, 460, 250, !1, 11, "twitter", !1, !1, function() {
                window.open("https://twitter.com/home?status=" +
                    encodeURIComponent(pb() + "https://whyisvercel.vercel.app/Evil%20Glitch/"))
            }],
            [430, 460, 250, !1, 12, "facebook", !1, !1, function() {
                window.open("https://www.facebook.com/sharer/sharer.php?u=" + (encodeURIComponent("https://whyisvercel.vercel.app/Evil%20Glitch/") + "&description=" + encodeURIComponent(pb())))
            }],
