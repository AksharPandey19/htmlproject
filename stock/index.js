...
function fetchTopStocks() {
    // Fetch data from api
    fetch('https://www.alphavantage.co/query?function=SECTOR&apikey=GMV2RGH5B19H90RR').then(response => response.json()).then(data => {
...
function fetchStockData(symbol) {
    ...
    fetch(`https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=GMV2RGH5B19H90RR`).then(response => response.json()).then(data => {
